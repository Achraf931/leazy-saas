...
watch(page, async (page) => {
  chapters.value = await client('/api/teacher/chapters', { params: { page } })
})
</script>
...
<template>
  ...
  <template v-if="!pending">
    ...
    <div v-if="filteredChapters.length && chapters.last_page > 1" class="p-2.5 flex items-center justify-center">
