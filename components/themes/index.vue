...
watch(page, async (page) => {
  themes.value = await client('/api/teacher/themes', { params: { page } })
})
</script>
...
<template>
  ...
  <template v-if="!pending">
    ...
    <div v-if="filteredThemes.length && themes.last_page > 1" class="p-2.5 flex items-center justify-center">
