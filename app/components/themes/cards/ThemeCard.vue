...
import { CreateThemeModal, ConfirmDeleteThemeModal } from '#components'
...
<template>
  <UBlogPost :to="localePath({ name: 'library-themes-id', params: { id: theme.id } })" :ui="{ wrapper: 'gap-y-0 hover:opacity-75', container: 'p-2 rounded-lg bg-gray-100 dark:bg-gray-800 border border-solid border-gray-200 dark:border-gray-700' }">
    <div class="flex items-start justify-between w-full">
      <div class="flex items-center gap-2">
        <UIcon name="i-heroicons-book-open" class="min-w-6 min-h-6" />
    ...
    <UBadge class="my-2" label="Math" variant="subtle" color="yellow" size="xs" />
