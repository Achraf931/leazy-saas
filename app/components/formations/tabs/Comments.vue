        ...
        <div class="relative pb-8">
          ...
          <div class="relative flex items-start space-x-3">
            <template v-if="activityItem.type === 'comment'">
              <div class="relative">
                <img class="flex h-10 w-10 items-center justify-center rounded-full bg-gray-400" :src="activityItem.imageUrl" alt="" />
              </div>
              ...
              <div>
                <div class="relative px-1">
                  <div class="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100">
                    <UIcon name="i-heroicons-user-circle" class="h-5 w-5 text-gray-500" />
                  </div>
                </div>
              </div>
            ...
            <template v-else-if="activityItem.type === 'tags'">
              <div>
                <div class="relative px-1">
                  <div class="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100">
                    <UIcon name="i-heroicons-question-mark-circle" class="h-5 w-5 text-gray-500" />
                  </div>
                </div>
              </div>
