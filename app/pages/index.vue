    ...
    <UDashboardPanel grow>
      ...
      <UDashboardPanelContent>
        <div class="grid grid-cols-3 gap-4">
          <div class="h-[380px] col-span-3 md:col-span-2 font-semibold border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 flex flex-col gap-4 p-4 rounded-lg">
          ...
          <div class="flex flex-col col-span-3 md:col-span-1 p-4 border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 rounded-lg">
          ...
          <div class="col-span-3 md:col-span-1 border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
          ...
          <div class="col-span-3 md:col-span-2 border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
