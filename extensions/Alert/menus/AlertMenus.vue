    ...
    <div class="bg-white rounded-lg dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700">
      <div class="flex gap-1 items-center">
        <ActionButton
          ...
          @click="props.editor.chain().focus().setAlertType('note').run()"
        ...
        <ActionButton
          ...
          @click="props.editor.chain().focus().setAlertType('info').run()"
        ...
        <ActionButton
          ...
          @click="props.editor.chain().focus().setAlertType('warning').run()"
        ...
        <ActionButton
          ...
          @click="props.editor.chain().focus().setAlertType('danger').run()"
        ...
        <ActionButton
          ...
          @click="props.editor.chain().focus().setAlertType('success').run()"
        ...
        <UTooltip :text="$t('editor.remove')" :popper="{ placement: 'bottom' }">
          <UButton
            ...
            size="xs"
            color="red"
            @click="props.editor.chain().focus().deleteNode('alert').run()"
